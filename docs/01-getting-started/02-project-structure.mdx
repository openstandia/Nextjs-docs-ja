...
次のファイルの規約は、[`pages` router](https://nextjs.org/docs/canary/pages)内でルートを定義するために使用されます。
...
| [`[...folder]/index`](https://nextjs.org/docs/canary/pages/building-your-application/routing/dynamic-routes#catch-all-segments)            | `.js` `.jsx` `.tsx` | catch-all route segument          |
| [`[[...folder]]/index`](https://nextjs.org/docs/canary/pages/building-your-application/routing/dynamic-routes#optional-catch-all-segments) | `.js` `.jsx` `.tsx` | オプショナルなcatch-allルートセグメント |
| **ファイルの規約**                                                                                                |                     |                                  |
| [`[file]`](https://nextjs.org/docs/canary/pages/building-your-application/routing/dynamic-routes)                                          | `.js` `.jsx` `.tsx` | 動的ルートセグメント               |
| [`[...file]`](https://nextjs.org/docs/canary/pages/building-your-application/routing/dynamic-routes#catch-all-segments)                    | `.js` `.jsx` `.tsx` | catch-all route segument          |
| [`[[...file]]`](https://nextjs.org/docs/canary/pages/building-your-application/routing/dynamic-routes#optional-catch-all-segments)         | `.js` `.jsx` `.tsx` | オプショナルなcatch-allルートセグメント |