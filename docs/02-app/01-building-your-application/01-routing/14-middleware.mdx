...
1. ルートに`rewrite`してレスポンスを生成する（[Page](https://nextjs.org/docs/canary/pages/building-your-application/routing/pages-and-layouts)または[Edge API Route](https://nextjs.org/docs/canary/pages/building-your-application/routing/api-routes)）
2. `NextResponse`を直接返す。「[レスポンスの生成](#producing-a-response)」を参照してください。
...
| `v12.2.0` | ミドルウェアが安定版になりました。 [アップグレードガイド](https://nextjs.org/docs/messages/middleware-upgrade-guide)を参照してください |
