...
> **Good to know**: Dynamic Segmentsは`pages`ディレクトリ内の[Dynamic Routes](https://nextjs.org/docs/canary/pages/building-your-application/routing/dynamic-routes)に相当します。
