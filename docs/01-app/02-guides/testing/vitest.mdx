---
title: 'Next.jsでのVitestのセットアップ方法'
nav_title: 'Vitest'
...
> **Good to know:** `async`なServer ComponentはReactエコシステムにおいて新しいため、Vitestは現在それをサポートしていません。同期的なServer ComponentやClient Componentの**ユニットテスト**は実行可能ですが、`async`なコンポーネントには**E2Eテスト**を使用することをお勧めします。
