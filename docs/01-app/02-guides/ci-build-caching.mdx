...
description: 'Next.jsビルドをキャッシュするためのCI設定方法を学びましょう'
---
...
Next.jsのキャッシングは自動的に設定されます。特に操作は必要ありません。VercelでTurborepoを使用している場合は、[こちら](https://vercel.com/docs/monorepos/turborepo)をご覧ください。
