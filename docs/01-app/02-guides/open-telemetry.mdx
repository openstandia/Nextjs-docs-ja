...
これを行うには、[OpenTelemetry Collector Getting Started guide](https://opentelemetry.io/docs/collector/getting-started/)に従って、コレクターを設定し、Next.jsアプリからデータを受信するように構成します。
...
- `next.rsc` (true/false) - リクエストがRSCリクエストであるかどうか（例：プリフェッチ）
- `next.page`
