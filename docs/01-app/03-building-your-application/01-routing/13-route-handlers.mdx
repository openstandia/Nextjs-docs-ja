...
`next/headers`から[`cookies`](/docs/app/api-reference/functions/cookies)を使用して、Cookieを読み取ったり設定したりできます。このサーバー関数は、Route Handler内で直接呼び出すことも、他の関数内にネストすることもできます。
...
また、基盤となるWeb APIを使用してリクエストからCookieを読み取ることもできます（[`NextRequest`](/docs/app/api-reference/functions/next-request)）：
...
`next/headers`から[`headers`](/docs/app/api-reference/functions/headers)を使用してヘッダーを読み取ることができます。このサーバー関数は、Route Handler内で直接呼び出すことも、他の関数内にネストすることもできます。
...
また、基盤となるWeb APIを使用してリクエストからヘッダーを読み取ることもできます（[`NextRequest`](/docs/app/api-reference/functions/next-request)）：
