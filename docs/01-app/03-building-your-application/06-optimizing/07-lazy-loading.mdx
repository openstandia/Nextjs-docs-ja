...
2. [Suspense](https://react.dev/reference/react/Suspense)と共に使用する[`React.lazy()`](https://react.dev/reference/react/lazy)
...
> **Note:** `ssr: false`オプションはserver componentではサポートされていません。server componentで使用しようとするとエラーが発生します。
