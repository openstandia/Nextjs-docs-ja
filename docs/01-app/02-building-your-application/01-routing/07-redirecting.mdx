...
`permanentRedirect` は、エンティティの正規URLが変更された後、たとえばユーザーがユーザー名を変更した後にプロフィールURLを更新する場合などに使用されます：
...
- [Vercel Edge Config](https://vercel.com/docs/storage/edge-config/get-started?utm_source=next-site&utm_medium=docs&utm_campaign=next-website) や [Redis](https://vercel.com/docs/storage/vercel-kv?utm_source=next-site&utm_medium=docs&utm_campaign=next-website) など、読み取りが高速なデータベースを使用する。
