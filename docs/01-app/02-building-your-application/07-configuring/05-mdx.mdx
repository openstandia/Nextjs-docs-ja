...
> **Good to know**:
>
> シリアライズ可能なオプションを持たないremarkとrehypeプラグインは、[RustにJavaScript関数を渡すことができないため](https://github.com/vercel/next.js/issues/71819#issuecomment-2461802968)、[Turbopack](/docs/architecture/turbopack)ではまだ使用できません。
