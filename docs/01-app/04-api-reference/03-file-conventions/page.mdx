...
- `searchParams`は、事前に値を知ることができない**[動的API](/docs/app/building-your-application/rendering/server-components#server-rendering-strategies#dynamic-apis)**です。これを使用すると、リクエスト時にページが**[動的レンダリング](/docs/app/building-your-application/rendering/server-components#dynamic-rendering)**されるようになります
